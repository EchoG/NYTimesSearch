...
<img src='https://github.com/EchoG/NYTimesSearch/blob/master/NYTimesSearch.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
The filter seach part is a challenge to me. I made a mistake when add the news_desk param to the params. It had 500 error and asked me to override onFailure method. I spent long time to debug it. From it, I know I need to be more careful when writing if conditions and dealing with Strings.

The Scroll down "infinitely" is also a little bit difficult to me, but the hint really helped me a lot!
